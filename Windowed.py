...
test = ImageTk.PhotoImage(file=path2)
...
# Вывод ОС
os = os_info()
os_result, os_platform = os[1], os[2]
...
cpu_result, cpu = cpu_complete_query[1], cpu_complete_query[2]
...
if success == 1:
    eth_score, down, up, test_ping = speedtest_result[2], speedtest_result[3], speedtest_result[4], speedtest_result[5]
    if eth_score == 5:
